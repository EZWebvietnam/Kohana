...
<!--form method="post" action="<?php echo URL::site()?>" name="filter">
<p class="show">
	<strong>Hiển thị:</strong>&nbsp;
	<input type="hidden" value="8" name="cPath">
	<input type="hidden" value="2a" name="sort">
	<select class="select" onchange="this.form.submit()" name="manufacturer_id">
		<option selected="selected" value="">Tất cả nhà sản xuất</option>
		<option value="1">Example-1</option>
		<option value="2">Example-2</option><option value="3">Example-3</option>
	</select>
</p>
</form-->
