...
?>
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first" class="pageResults"><<</a>
	<?php endif ?>
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php else: ?>
			<a href="<?php echo HTML::chars($page->url($number)) ?>" class="pageResults"><?php echo $content ?></a>
		<?php endif ?>

	<?php endforeach ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last" class="pageResults">>></a>
	<?php endif ?>
