...
class Utils{
	...
	{
		return is_array($data)?array_map(array('Utils','stripSlashes'),$data):stripslashes($data);
	}

	public static function add_slashes(&$data)
	{
		return is_array($data)?array_map(array('Utils','addSlashes'),$data):addslashes($data);
	}

	public static function encode_data($data)
	{
		if(is_array($data))
			return array_map(array('Utils','encodeData'),$data);
		else
	...
	{
		if(is_array($data))
			return array_map(array('Utils','decodeData'),$data);
		else
			return strtr($data,array('&amp;' => '&','&quot;' => '"','&#039;'=>"'",'&lt;' => '<','&gt;' => '>'));
	}
	...
	public static function url_lize($string, $separator = '_')
	{
