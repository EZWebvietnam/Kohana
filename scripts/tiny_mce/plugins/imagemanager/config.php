<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '/presente'; // absolute or relative from this script path, optional.
	//$mcImageManagerConfig['filesystem.rootpath'] = 'files'; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.rootpath'] = 'C:\Wamp\htdocs\presente\upload\images'; // absolute or relative from this script path, required.
	...
	// Authenication
	$mcImageManagerConfig['authenticator'] = "BaseAuthenticator";//SessionAuthenticator
